...
$errorMessage = "";
$successMessage = "";
$TotalNumberOfMedicine = 0;
$TotalTypeOfMedicine = 0;
$TotalSoldItem = 0;
$TotalRevenue = 0;
...
$result2 = mysqli_query($conn, "SELECT * FROM pharmacey.soldcollection ");
$checkData2 = mysqli_num_rows($result2);

if ($checkData2 > 0) {
  
   // Iterate through each row fetched
   while ($row = mysqli_fetch_array($result2)) {
       // Increment the total number of medicines by the QuantityAvailable of each row
       $TotalSoldItem += $row['Quantity'];
       $TotalRevenue +=   $row['Price'];
   }
}
if ($checkData > 0) {
   $TotalTypeOfMedicine = $checkData;
    // Iterate through each row fetched
    while ($row = mysqli_fetch_array($result)) {
        // Increment the total number of medicines by the QuantityAvailable of each row
        $TotalNumberOfMedicine += $row['QuantityAvailable'];
                    ...
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <h5 class="font-15">Total medicine Quantity</h5>
                          <h2 class="mb-3 font-18"><?php echo $TotalNumberOfMedicine ?></h2>
                ...
                <div class="card-statistic-4">
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <h5 class="font-15"> Total Type Of Medicine Avalable</h5>
                          <h2 class="mb-3 font-18"><?php echo $TotalTypeOfMedicine ?></h2>
                ...
                <div class="card-statistic-4">
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <h5 class="font-15">Total number of Medicine Sold</h5>
                          <h2 class="mb-3 font-18"><?php echo $TotalSoldItem ?> </h2>
                    ...
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          ...
                          <h2 class="mb-3 font-18"><?php echo $TotalRevenue ?> birr</h2>
